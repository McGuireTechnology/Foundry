...
final class AppSession: ObservableObject {
    ...
    private let client: FoundryAPIClient
    ...
    init(
        ...
        self.client = FoundryAPIClient(environment: environment)
    ...
    func signUp(email: String, password: String) async -> String? {
        ...
        do {
            ...
            route = .signIn
            return nil
        } catch let apiError as FoundryAPIError {
    ...
    private func mapSignInError(_ error: Error) -> String {
        guard let apiError = error as? FoundryAPIError else {
            return "Unable to reach the API. Please try again."
        }
...
private extension FoundryAPIError {
    var isTimedOut: Bool {
