...
final class CredentialsStore {
    ...
    private enum Key {
        static let accessTokenLegacy = "vortex.access_token"
        static let refreshTokenLegacy = "vortex.refresh_token"
        static let accessTokenAccount = "vortex.access_token"
        static let refreshTokenAccount = "vortex.refresh_token"
        static let currentUserEmail = "vortex.current_user_email"
        static let rememberedEmail = "vortex.remembered_email"
    }
...
struct KeychainStore {
    ...
    private static var defaultService: String {
        let bundleIdentifier = Bundle.main.bundleIdentifier ?? "technology.mcguire.vortex"
